...
Level 2 means fully conforming, able to send and receive multicast traffic.
...
\def\setsockopt{\texttt{set\-sock\-opt} }
...
Syscalls \texttt{setsockopt} related to the multicast have option names starting
