...
have the same metric. If you send packets from the \ttt{send} node, you should see
...
\ttt{netlab-r2} namespace. This naming convention is very conventional, you can
